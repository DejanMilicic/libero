...
pub fn write_dispatch(
  ...
  let all_imports =
    list.flatten([message_type_imports, handler_imports])
...
pub fn send_to_client(
  ...
  push.send_to_client(client_id:, module: \""
        <> m.module_path
        <> "\", msg:)
}
...
pub fn send_to_clients(
  ...
  push.send_to_clients(topic:, module: \""
        <> m.module_path
        <> "\", msg:)
}
"
...
pub fn write_websocket(
  ...
  let ffi_module =
    string.replace(module_path, "/", "@") <> "@websocket"
