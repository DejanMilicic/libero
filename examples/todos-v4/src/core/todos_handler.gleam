...
import core/generated/todos as todos_push
...
@external(erlang, "todos_v4_store_ffi", "create_table")
fn create_table() -> Nil

@external(erlang, "todos_v4_store_ffi", "next_id")
fn next_id() -> Int

@external(erlang, "todos_v4_store_ffi", "put")
fn put(id: Int, item: Todo) -> Nil

@external(erlang, "todos_v4_store_ffi", "get")
fn get(id: Int) -> Result(Todo, Nil)

@external(erlang, "todos_v4_store_ffi", "all_rows")
fn all_rows() -> List(Todo)

@external(erlang, "todos_v4_store_ffi", "delete_row")
fn delete_row(id: Int) -> Nil

@external(erlang, "todos_v4_store_ffi", "int_compare")
