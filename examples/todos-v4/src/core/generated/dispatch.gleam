...
import core/todos_handler as core_todos_handler_handler

@external(erlang, "todos_v4@generated@rpc_atoms", "ensure")
fn ensure_atoms() -> Nil
...
pub fn handle(
  ...
  case wire.decode_call(data) {
    Ok(#("core/todos", msg)) ->
      dispatch(state, fn() { core_todos_handler_handler.update_from_client(msg: wire.coerce(msg), state:) })
    Ok(#(name, _)) ->
