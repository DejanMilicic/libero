...
/// {<<"test">>, [value]}, decodes it back via wire.decode_call, and
...
/// Encode a value, wrap it as an RPC call arg, decode it back.
fn roundtrip(value: a) -> Dynamic {
  let envelope = ffi_encode(coerce(#("test", [coerce(value)])))
